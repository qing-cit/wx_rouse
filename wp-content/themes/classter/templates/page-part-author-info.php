...
?>
	<section class="author vcard<?php echo get_custom_option("show_post_related") == 'yes' || get_custom_option("show_post_comments") == 'yes' ? ' hrShadow' : ''; ?>" itemprop="author" itemscope itemtype="<?php echo themerex_get_protocol(); ?>://schema.org/Person">
		<div class="wrap">
