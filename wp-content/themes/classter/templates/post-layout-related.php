...
<div class="wrap<?php echo esc_attr($post_data['post_thumb'] ? ' thumb' : ' no_thumb');  ?>">
	<?php if ($post_data['post_thumb']) {
			...
			<?php } else { ?>
			<div class="thumb hoverIncrease hoverTwo" data-link="<?php echo esc_url($post_data['post_link']); ?>" data-image="<?php echo esc_url($post_data['post_attachment']); ?>" data-title="<?php echo esc_attr($post_data['post_title']); ?>">
