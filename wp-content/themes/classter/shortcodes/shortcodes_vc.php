...
//-------------------------------------------------------------------------------------
			...
			class WPBakeryShortCode_Trx_Text_Slider_Item extends THEMEREX_VC_ShortCodeSingle {}
...
//-------------------------------------------------------------------------------------
    ...
    ',
			...
			vc_map(array(
				...
				"show_settings_on_create" => true,
				"class" => "trx_sc_container trx_sc_column_item trx_sc_team_item",
				"content_element" => true,
				"is_container" => true,
