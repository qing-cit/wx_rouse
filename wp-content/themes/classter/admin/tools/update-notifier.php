...
define( 'NOTIFIER_THEME_NAME', 'Classter' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'classter' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://themerex.net/!updates/updates_classter.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
